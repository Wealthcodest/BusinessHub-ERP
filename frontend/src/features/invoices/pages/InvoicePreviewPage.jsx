...
import { Button, LoadingSkeleton, PageHeader } from "@/components/ui";
...
export default function InvoicePreviewPage() {
  ...
  return <div className="space-y-6"><PageHeader title="Invoice Preview" actions={<Button onClick={() => window.print()}><Printer className="mr-2 h-4 w-4" />Print</Button>} /><InvoicePreview invoice={invoice} business={business} customer={customer} resolvedTheme={resolvedTheme} /></div>;
}
